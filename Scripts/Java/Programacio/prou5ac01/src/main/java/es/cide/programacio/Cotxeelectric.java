...
public class Cotxeelectric extends Cotxe implements Recarregable {
    private int bateriaMax, bateriaActual;
    public Cotxeelectric(String matricula, String marca, int plaçes, double velocitatMaxima, double preu,
            int bateriaMax, int bateriaActual) {
