...
public class Main {
    public static void main(String[] args) {
        ...
        //Comienza el juego
        while (Guybrush.getestatheroi() && illaLongitud > 0) {// mientras el heroe este vivo y la isla tenga piratas 
            ...
            System.out.println();
            // Comienza la ronda
            while (Guybrush.getestatheroi() && pirataRonda.getestatpirata()) {// mientras el heroe y el pirata de la ronda esten vivos
                ...
                if (!pirataRonda.getestatpirata()) {// si el pirata ha muerto
                    ...
                    System.out.println();
                } else if (Guybrush.getestatheroi() == false) {// si el heroe ha muerto
        ...
        if (Guybrush.getestatheroi()) {// si el heroe sigue vivo al final del juego
